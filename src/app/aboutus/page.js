...
import InstagramFeed from '../components/InstagramFeed'; // Re-using the Instagram component

export default function AboutPage() {
  // Data for the team section to keep the JSX clean
  const teamData = [
            ...
            <div className="row gx-5 align-items-center">
              ...
              <div className="col-lg-6">
                <div className="row g-4">
                  <div className="col-6">
                    <img src="/images/misc/lokaci image 5.webp" className="img-fluid mb-4 wow zoomIn" alt="Salon Interior" />
                  ...
                  <div className="col-6">
                    ...
                    <img src="/images/misc/lokaci image 6.webp" className="img-fluid mt-4 wow zoomIn" alt="Salon Treatment Room" />
                  </div>
                </div>
              </div>
            </div>
