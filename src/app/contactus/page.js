            ...
            <div className="container relative z-index-1000">
              <div className="row justify-content-center">
                <div className="col-lg-6 text-center">
                  <h1 className="heading-small">Get In Touch</h1>
                  <p className="lead mt-3">
                    Whether you have a question about our haircuts, facials, or
                    any other service, our team is ready to assist. Contact us
                    to schedule your next appointment or consultation.
                  </p>
                  <ul className="crumb">
                    <li>
                      <Link href="/">Home</Link>
                  ...
                  >
                    ...
                    {formStatus === "error" && (
                      <div
                        ...
                        style={{ display: "block", marginTop: "20px" }}
                      >
                        Sorry, there was an error sending your form. Please try
                        again later.
                      </div>
                    )}
                  </form>
