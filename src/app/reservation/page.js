...
import { allServicesData } from '../services.js'; // Importing from the new file

export default function ReservationPage() {
  // Dynamically get the first service to set as default
  ...
  // --- BRINGING BACK useEffect FOR THE ORIGINAL DATE PICKER ---
  useEffect(() => {
    // A small delay to ensure scripts are fully loaded and ready
